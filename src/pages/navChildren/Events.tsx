        ...
        <div className="grid grid-cols-1 md:grid-cols-10 gap-6">
          ...
          <div className="md:col-span-3 rounded-2xl p-5 bg-linear-to-b from-red-50 to-white dark:from-red-500 dark:to-gray-900 shadow-xl border border-red-200 dark:border-red-500 animate-[fadeInUp_0.6s_ease-out] h-130">
            ...
            <div className="space-y-6 text-sm text-gray-700 dark:text-gray-300">
              ...
              {/* CLEAR BUTTON */}
              <button className="w-full mt-5 py-3 rounded-xl bg-linear-to-r from-red-500 to-red-600 text-white font-semibold hover:from-red-600 hover:to-red-700 active:scale-95 transition-all duration-300 shadow-lg animate-[fadeInUp_1.1s_ease-out]">
                Clear Filters
              </button>
            </div>
          </div>
          ...
          <div className="md:col-span-7 bg-white dark:bg-black rounded-xl p-4 shadow-sm">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
              {movies.map((movie) => (
                <div key={movie.id}>
                  {/* IMAGE CARD */}
                  <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md overflow-hidden cursor-pointer h-64 sm:h-80">
                    <img
                      src={movie.poster}
                      alt={movie.title}
